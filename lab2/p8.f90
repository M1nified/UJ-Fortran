...
jill%last_name = "Clinton"

PRINT *, jill%last_name

PRINT *, jack%age

IF(jack%sex == "F") PRINT *, TRIM(jack%first_name), " jest kobieta"
IF(jill%sex == "F") PRINT *, TRIM(jack%first_name), " jest kobieta"

PRINT *, "przed", TRIM("   12   "), "po"
